/* This file was originally named fminbr.cc, and is distributed as 
 * part of the public domain LinAlg library:
 *   http://okmij.org/ftp/NumMath.html
 */
...
{
    /* Caller is now responsible for this error-checking.
  ...
  static const double r = 0.38196601125010515180;
  ...
  for(;;)		// Main iteration loop
  {
    ...
    register const double ft = f(t, user_data);
    if( ft <= fx )
